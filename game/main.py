...
from screens import MainScreen, GameScreen, MultiplayerScreen, RegisterScreen
...
def main(screen: Screen):
    ...
    fire = Fire(screen.height, screen.width // 2, '*' * 70, 0.8, 60, screen.colours, screen.colours >= 256)
    effects = [
        Print(screen, fire, 0, speed=1, transparent=False),
